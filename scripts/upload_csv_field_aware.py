...
def discover_schema(base_id, table_id_or_name, headers):
    ...
    # Try schema API (needs schema.bases:read). If not allowed, fall back to sampling records.
...
def main():
    ...
    # 2) Map CSV -> your real columns (covers typical variants)
    ...
    with open(csv_path, newline="", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            if cluster_field and clu:
                ...
                # else: schema unknown → conservative skip to avoid INVALID_MULTIPLE_CHOICE_OPTIONS
